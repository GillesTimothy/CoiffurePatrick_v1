                ...
                <div class="panel-body">
                    <form method="post" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input name="product_stock" type="number" class="form-control" required>
                            </div>
                        </div>
...
if(isset($_POST['submit'])){
    ...
    $product_stock = $_POST['product_prix'];
    ...
    $insert_product = "insert into produits (pCategorieId, categorieId, date, libelle, produitImage1, produitImage2, produitImage3, prix, description, stock) values ('$product_cat','$cat', NOW(), '$product_title', '$product_img1', '$product_img2', '$product_img3', '$product_price', '$product_desc', '$product_stock')";
