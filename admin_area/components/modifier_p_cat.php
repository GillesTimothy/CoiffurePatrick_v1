...
<?php 
    ...
    if(isset($_GET['modifier_p_cat'])){
        ...
        $edit_id = $_GET['modifier_p_cat'];
        $get_s = "select * from categorie_produit where idCategorie='$edit_id'";
        $run_edit = mysqli_query($con,$get_s);
        $row_edit = mysqli_fetch_array($run_edit);
        
        $c_id = $row_edit['idCategorie'];
...
<head>
    ...
    <title> Modification Catégorie Produits </title>
</head>
<body>
...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            <li class="active">
                <i class="fa fa-dashboard"></i> Dashboard / Modification Catégorie Produits
            </li>
        </ol>
    </div>
</div> 
        ...
        <div class="panel panel-default">
           <div class="panel-heading">
               <h3 class="panel-title">
                   <i class="fa fa-money fa-fw"></i> Modification Catégorie Produits
               </h3>
           </div>
...
if(isset($_POST['update'])){
    ...
    $update_cat = "update categorie_produit set libelle='$cat_title' where idCategorie='$c_id'";
